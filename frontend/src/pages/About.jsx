...
const About = () => {
  ...
  return (
    <>
      <Helmet>
        <title>About Us | InfoLand AI</title>
        <meta name="description" content="Learn about InfoLand AI's mission and dataset engine." />
      </Helmet>
      <div className="flex flex-col min-h-screen bg-white">
        {/* Editorial Header */}
        <section className="pt-40 pb-24 border-b border-slate-100">
          <div className="max-w-7xl mx-auto px-6 lg:px-8 xl:px-10 text-center">
            <motion.h1 
